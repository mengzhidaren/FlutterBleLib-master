...
class WelcomeScreen extends StatelessWidget {
  static const String _welcomeMessage =
      "Welcome in flutter ble example. This app shows you all functionality of our library. Swipe qright to get more information";
  ...
  Widget build(BuildContext context) {
    ...
    final Widget flutterIcon = new Container(
        ...
        child: new Image.asset(
          'images/flutter-ble-lib-logo-small.png',
          width: 250.0,
          height: 145.0,
        ));
...
class InfoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle textStyleMessage = Theme.of(context).textTheme.body1;
    final Text message = new Text(
      _infoMessage,
      style: textStyle,
    );
    final List<Widget> list =
        _infoPoints.map((text) => _checkboxWithLabel(context, text)).toList();
...
class CreateScreen extends StatelessWidget {
  static const String _createMessage =
      "Just click on button and check our libs";
