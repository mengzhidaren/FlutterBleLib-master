...
class FlutterBleLib {
  ...
  Future<Null> setLogLevel(LogLevel logLevel) => _mainMethodChannel
  ...
  ///response  true请求远程设备进行确认   false写入特性而无需远程设备的响应
  ///transactionId  事件ID
...
//        _valueBase64: BASE64.encode(bytes),
        _valueBase64: Base64Codec().encode(bytes),
        _response: response,
        _transactionId: transactionId,
      });
