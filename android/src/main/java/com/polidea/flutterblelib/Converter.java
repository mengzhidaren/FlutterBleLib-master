...
//        BleData.ScanResultMessage.Builder builder = BleData.ScanResultMessage.newBuilder().setBleDeviceMessage(convertToBleDeviceMessage(scanResult.getBleDevice()))
...
////            Log.i("yyl","scanResult getScanRecord="+ Arrays.toString(data));
//            builder.addScanRecord(ByteString.copyFrom(data));
//        }
//        return builder.build();
        ...
        return BleData.ScanResultMessage.newBuilder()
                ...
                .setTimestampNanos(scanResult.getTimestampNanos())
                .setScanCallbackTypeMessage(scanResult.getCallbackType().ordinal())
                .addScanRecord(ByteString.copyFrom(scanResult.getScanRecord().getBytes()))
                .build();
    }
